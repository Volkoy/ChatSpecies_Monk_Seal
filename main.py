...
def chat_message(name):
    if name == "assistant":
        return st.container(key=f"{name}-{uuid.uuid4()}").chat_message(name=name, avatar="seal.png", width="content")
    else:
...
language_texts = {
    "English": {
        ...
        "subtitle": "A Mediterranean Monk Seal.",
...
def main():
    ...
    if 'tts_voice' not in st.session_state:
        st.session_state.tts_voice = 'Ethan' 
    ...
    st.markdown("""
        ...
        .stChatInput div[data-testid="stChatInput"]:focus-within {
            ...
            box-shadow: 0 0 0 2px rgba(69, 161, 170, 0.3) !important;
        }
        ...
        .stChatInput div[data-testid="stChatInput"]:focus-within {
            border-color: #45a1aa !important;
            box-shadow: 0 0 0 1px rgba(69, 161, 170, 0.5) !important;
        }
